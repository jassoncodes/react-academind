...
{
    return (
        <aside className="flex flex-col flex-shrink-0 left-0 w-64 hover:w-64 bg-neutral-200 text-gray-600 transition-all duration-300 border-none sidebar min-w-14 overflow-y-auto">
